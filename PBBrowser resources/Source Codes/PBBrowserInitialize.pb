...
;                                 etc.
;
; NOTE: three files are include below : AddToolToPureBasic.pb, HelpAndTools.pb
;       and FindInPBCode.pb (Look arround line 800)
;
; *****************************************************************************
;
...
Procedure InstallPBBTool()
  ...
  ;
  ; Layout variables:
  Protected WWidth, WHeight, Vpos, Margins, LineHeight
  ; Gadget numbers:
  ...
  InstallWindow = OpenWindow(#PB_Any, 0, 0, WWidth, WHeight, GetTextFromCatalogPB("FirstLaunch"), #PB_Window_SystemMenu|#PB_Window_ScreenCentered)
  If InstallWindow
